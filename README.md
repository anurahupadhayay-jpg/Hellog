...
- **SaaS Monetization** - Tier-based premium plans with automated UPIGateway payments
- **Retention Discount** - Auto 50% discount on renewals for existing users
...
## Architecture
    ...
    │   ├── monetization.py      # Timer, plans & UPIGateway logic
...
- UPIGateway API Key for automated payments
### 2. Clone and Install
...
| `/plans` | View premium plans and 50% discount offers |
| `/buy [amount]` | Buy a plan automatically via UPIGateway |
...
## Monetization Model
- **Plans:** 1 Hour (₹1), 2 Days (₹10), 5 Days (₹15), 1 Month (₹50), 1 Year (₹499)
- **Retention Offer:** 50% discount automatically applied on second purchase
...
| `UPIGATEWAY_API_KEY` | - | UPIGateway API Key for auto payments |
